...
const createBookItemsHtml = () => {
   ...
   bookList.forEach((book, index) => {
      bookListHtml += `
        ...
        <div class="col-5 ${index % 2 == 0 && "offset-2"}">
        <!--  ROW 2 -->
           <div class="row book__card">

              <!-- Col 1 > col-6 // col-4 olarak değiştirildi -->
              <div class="content1 col-4">
                 <img class="img-fluid shadow" src="${
                    book.imgSource
                 }" alt="Nutuk" width="260" height="400px">
              </div>

              <!--Col 2 > col-6 -->
              <div class="content2 col-6">
                 <div class="book__detail">
                    ...
                    <span class="book__star-rate">
                       ...
                       <span class="">${book.reviewCount}reviews</span>
                    </span>
                 ...
                 <div>
                    <span id="old_price" class="black fw-bold fs-5 m-1">${
                       book.price
                    }₺</span>
                    ${
                       book.oldPrice
                          ? `<span id="old_price" class="new-gray fw-bold fs-5 text-decoration-line-through">${book.oldPrice}₺</span>`
                          : ""
                    }
                 </div>
...
const listBasketItems = () => {
   ...
   basketList.forEach((item) => {
      ...
      <div class="col-4 basket__item-info">
...
const addBookToBasket = (bookId) => {
   ...
   if (findedBook) {
      ...
      listBasketItems();
      toastr.info(`Book added to basket succesfully.`);
   }
};
...
const increaseItemToBasket = (bookId) => {
   ...
   if (findedIndex != -1) {
      if (
         ...
         basketList[findedIndex].product.stock
      )
         basketList[findedIndex].quantity += 1;
